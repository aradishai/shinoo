...
const SHOP_ITEMS = [
  ...
  { id: 'double', name: 'דאבל', description: 'לשימוש לפני המשחק – שייך ל-2 משחקים שונים. אם שניהם מנוחשים נכון, תקבל בונוס נקודות על שניהם!', img: '/btn-double.png', stockKey: 'doubleStock' as const, comingSoon: false, cost: 3, imgClass: 'w-40 h-16' },
]
