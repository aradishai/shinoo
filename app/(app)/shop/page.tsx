...
const SHOP_ITEMS = [
  ...
  { id: 'goals', name: 'גולס+', description: 'לשימוש לפני המשחק – כל גול שווה נקודה', img: '/btn-goals.png', stockKey: 'goalsStock' as const, comingSoon: false, cost: 4 },
  { id: 'minute90', name: 'דקה 90', description: "לשימוש עד דקה 90' – הגרלת ניחוש", img: '/btn-90.png', stockKey: 'minute90Stock' as const, comingSoon: false, cost: 2 },
