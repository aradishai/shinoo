...
const SHOP_ITEMS = [
  ...
  { id: 'split', name: 'ספליט', description: 'לשימוש לפני המשחק – ניחוש 2 תוצאות', img: '/btn-split.png', stockKey: 'splitStock' as const, comingSoon: false, cost: 2 },
]
                ...
                <div className="flex-1 flex items-center justify-start gap-2 pl-2">
                  <div className="relative">
                    <img
                      src={item.img}
                      alt={item.name}
                      className="h-7 w-20 object-contain rounded-lg"
