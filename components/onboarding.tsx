    ...
    <div className="w-full flex flex-col gap-4 text-right">
      ...
      <div className="flex flex-col gap-2 pt-2">
        ...
        <a
          ...
          className="flex items-center justify-center gap-6 active:scale-95 transition-transform duration-150"
        >
          <img src="/laliga-logo.png" alt="LaLiga" className="h-28 w-auto shrink-0" />
